## Script taken from the guide at https://pawseysc.github.io/singularity-containers/44-setup-singularity/index.html
## Only change made is changing the ARCH variable to arm64 for M1 Macs
